...
const sensorTypeId = route.params.id
...
<template>
  <VCard class="bg-primary-surface rounded-xl py-4">
        <VCardTitle>
        ...
        <VCardText class="bg-white mx-3 mb-3 rounded-xl">
          <VForm ref="form" fast-fail @submit.prevent="handleSubmit" class="py-3">
            <label for="name" class="text-neutral-900 weight-500" style="font-size: 18px">Sensor Name</label>
            <VTextField
              id="name"
              variant="outlined"
              :loading="isPosting"
